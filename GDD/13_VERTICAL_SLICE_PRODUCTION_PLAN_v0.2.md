...
- [x] Başlangıç ve bitiş ile rota önizleme ekle. (`Yol Kur`: ilk sol tık başlangıcı seçer; sonraki her sol tık önceki ucundan yeni rotayı kurar ve araç sağ tıkla bitene kadar açık kalır. `Yol Sil` araç açık kaldığı sürece her sol tıkta tek karo siler; sağ tık her iki yol aracını da iptal eder. Hover önizlemesi, geçersiz rota ve odun yetersizliği geri bildirimi.)

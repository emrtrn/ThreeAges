...
export type PlacementFailure = "outside-map" | "outside-control" | "blocked" | "insufficient-resources" | "missing-resource-node" | "missing-forest" | "missing-game" | "enemy-occupied";
